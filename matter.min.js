  ...
  return (function (e) {
    ...
    function (e, t) {
      ...
      (e.exports = n),
        ...
        (n.rotateAbout = function (e, t, n, i) {
          ...
          return (
            (i.y = n.y + ((e.x - n.x) * r + (e.y - n.y) * o)), (i.x = s), i
          );
        }),
    ...
    function (e, t, n) {
      ...
      (i.create = function (e, t) {
        ...
        (i.centre = function (e) {
          for (
            var t, n, r, s = i.area(e, !0), a = { x: 0, y: 0 }, l = 0;
            l < e.length;
            l++
          )
            (r = (l + 1) % e.length),
        ...
        (i.inertia = function (e, t) {
          for (var n, i, r = 0, s = 0, a = e, l = 0; l < a.length; l++)
            (i = (l + 1) % a.length),
              (r +=
                (n = Math.abs(o.cross(a[i], a[l]))) *
                (o.dot(a[i], a[i]) + o.dot(a[i], a[l]) + o.dot(a[l], a[l]))),
              (s += n);
          return (t / 6) * (r / s);
        }),
        ...
        (i.chamfer = function (e, t, n, i, s) {
          ...
          for (var a = [], l = 0; l < e.length; l++) {
            ...
            if (0 !== p) {
              var f = o.normalise({ x: d.y - c.y, y: c.x - d.x }),
                v = o.normalise({ x: u.y - d.y, y: d.x - u.x }),
    ...
    function (e, t, n) {
      ...
      (i.create = function (e) {
        ...
        (i.scale = function (e, t, n, o, r) {
          for (
            var s = r ? i.allBodies(e) : e.bodies, l = 0;
            l < s.length;
            l++
          ) {
            var c = s[l],
              d = c.position.x - o.x,
              u = c.position.y - o.y;
            a.setPosition(c, { x: o.x + d * t, y: o.y + u * n }),
              a.scale(c, t, n);
          }
          return i.setModified(e, !0, !0, !1), e;
        }),
        ...
        (i.set = function (e, t, n) {
          ...
          (i.scale = function (e, t, n, r) {
            ...
            for (var d = 0; d < e.parts.length; d++) {
              ...
              o.scale(u.vertices, t, n, r),
                ...
                o.translate(u.vertices, { x: -u.position.x, y: -u.position.y }),
                i.setInertia(
                  u,
                  i._inertiaScale * o.inertia(u.vertices, u.mass)
                ),
                o.translate(u.vertices, { x: u.position.x, y: u.position.y }),
            ...
            e.parts.length > 1 &&
              ((e.area = s),
              e.isStatic || (i.setMass(e, e.density * s), i.setInertia(e, a))),
              e.circleRadius &&
          ...
          (i.update = function (e, t, n, i) {
            ...
            (e.velocity.x = d * a * i + (e.force.x / e.mass) * s),
              ...
              (e.angularVelocity =
                (e.angle - e.anglePrev) * a * i + (e.torque / e.inertia) * s),
              (e.anglePrev = e.angle),
            ...
            if (r.isActive) {
              ...
              if (
                ...
                var c = a.isSleeping && !a.isStatic ? a : l,
                  d = c === a ? l : a;
                !c.isStatic &&
                  d.motion > i._motionWakeThreshold * n &&
                  i.set(c, !1);
              }
            }
          }
        ...
        (i.solve = function (e, t) {
          ...
          if (n || o) {
            n &&
              ...
              o &&
                !o.isStatic &&
                (r.rotate(a, o.angle - e.angleB, a), (e.angleB = o.angle));
            var l = s,
              c = a;
            if (
              ...
              if (e.damping) {
                ...
                (v = r.div(d, u)),
                  (y = r.sub(
                    ...
                    (n && r.sub(n.position, n.positionPrev)) || S
                  )),
                  (m = r.dot(v, y));
              }
              n &&
            ...
            if (!(n.isStatic || (0 === c.x && 0 === c.y && 0 === c.angle))) {
              ...
              for (var d = 0; d < n.parts.length; d++) {
                ...
                o.translate(u.vertices, c),
                  ...
                  0 !== c.angle &&
                    (o.rotate(u.vertices, c.angle, n.position),
    ...
    function (e, t, n) {
      ...
      !(function () {
        ...
        "undefined" != typeof window &&
          ...
          (i.run = function (t) {
            !(function n(o) {
              (t.frameRequestId = e(n)), i.world(t);
            })();
          }),
          (i.stop = function (e) {
            t(e.frameRequestId);
          ...
          (i.world = function (e) {
            ...
            if (
              ...
              for (t = 0; t < y.length; t++) {
                ...
                A && (C = c.add(A.position, S.pointA)),
                  ...
                  C &&
                    M &&
                    (s.contains(e.bounds, C) || s.contains(e.bounds, M)) &&
                    h.push(S);
              }
            ...
            !v.wireframes || (n.enableSleeping && v.showSleeping)
              ? i.bodies(e, x, p)
              : (v.showConvexHulls && i.bodyConvexHulls(e, x, p),
          ...
          (i.debug = function (e, t) {
            ...
            if (i.timing.timestamp - (e.debugTimestamp || 0) >= 500) {
              ...
              s.timing && (d += "fps: " + Math.round(s.timing.fps) + "    "),
                s.extended &&
                  (s.timing &&
                    ((d += "delta: " + s.timing.delta.toFixed(3) + "    "),
                    (d +=
                      "correction: " +
                      s.timing.correction.toFixed(3) +
                      "    ")),
                  (d += "bodies: " + c.length + "    "),
          ...
          (i.bodyShadows = function (e, t, n) {
            for (var i = n, o = (e.engine, 0); o < t.length; o++) {
              var r = t[o];
              if (r.render.visible) {
                if (r.circleRadius)
                  i.beginPath(),
                ...
                (i.shadowColor = "rgba(0,0,0,0.15)"),
                  (i.shadowOffsetX = 0.05 * a),
                  (i.shadowOffsetY = 0.05 * l),
                  ...
                  if ((o = i.parts[s]).render.visible) {
                    if (
                      (l.showSleeping && i.isSleeping
                        ? (a.globalAlpha = 0.5 * o.render.opacity)
                        : 1 !== o.render.opacity &&
                          (a.globalAlpha = o.render.opacity),
                      o.render.sprite &&
                      ...
                      if (o.circleRadius)
                        ...
                        for (var f = 1; f < o.vertices.length; f++)
                          !o.vertices[f - 1].isInternal || c
                            ? a.lineTo(o.vertices[f].x, o.vertices[f].y)
                            : a.moveTo(o.vertices[f].x, o.vertices[f].y),
                      ...
                      l.wireframes
                        ? ((a.lineWidth = 1),
                          (a.strokeStyle = "#bbb"),
                          a.stroke())
                        : ((a.fillStyle = o.render.fillStyle),
                          o.render.lineWidth &&
                            ((a.lineWidth = o.render.lineWidth),
              ...
              if ((i = t[r]).render.visible)
                for (a = i.parts.length > 1 ? 1 : 0; a < i.parts.length; a++) {
                  for (
                    ...
                    !o.vertices[s - 1].isInternal || c
                      ? l.lineTo(o.vertices[s].x, o.vertices[s].y)
                      : l.moveTo(o.vertices[s].x, o.vertices[s].y),
                      o.vertices[s].isInternal &&
                        !c &&
                        l.moveTo(
                          o.vertices[(s + 1) % o.vertices.length].x,
                          o.vertices[(s + 1) % o.vertices.length].y
                        );
          ...
          (i.bodyConvexHulls = function (e, t, n) {
            ...
            for (s.beginPath(), o = 0; o < t.length; o++)
              if ((i = t[o]).render.visible && 1 !== i.parts.length) {
                for (
                  s.moveTo(i.vertices[0].x, i.vertices[0].y), r = 1;
                  r < i.vertices.length;
                  r++
                )
              ...
              if (
                ...
                2 === i.activeContacts.length &&
                  ...
                  o.bodyB === o.supports[0].body || !0 === o.bodyA.isStatic
                    ? a.moveTo(d - 8 * o.normal.x, u - 8 * o.normal.y)
                    : a.moveTo(d + 8 * o.normal.x, u + 8 * o.normal.y),
                  a.lineTo(d, u);
              }
            l.wireframes
          ...
          (i.separations = function (e, t, n) {
            ...
            for (l.beginPath(), a = 0; a < t.length; a++)
              if ((i = t[a]).isActive) {
                ...
                var d = 1;
                (s = o.bodyB).isStatic || r.isStatic || (d = 0.5),
                  s.isStatic && (d = 0),
                  l.moveTo(s.position.x, s.position.y),
                  l.lineTo(
                    s.position.x - o.penetration.x * d,
                    s.position.y - o.penetration.y * d
                  ),
                  (d = 1),
                  ...
                  l.lineTo(
                    r.position.x + o.penetration.x * d,
                    r.position.y + o.penetration.y * d
                  );
              }
            c.wireframes
        ...
        (i.update = function (e, t, n, o) {
          ...
          for (f.broadphaseTests = 0, r = 0; r < t.length; r++) {
            ...
            if (
              (!v.isSleeping || o) &&
              !(
                v.bounds.max.x < d.bounds.min.x ||
                v.bounds.min.x > d.bounds.max.x ||
                v.bounds.max.y < d.bounds.min.y ||
                v.bounds.min.y > d.bounds.max.y
              )
            ) {
    ...
    function (e, t, n) {
      ...
      (i.collisions = function (e, t) {
        for (
          var n = [], a = t.pairs.table, l = t.metrics, c = 0;
          c < e.length;
          c++
        ) {
          var d = e[c][0],
          ...
          if (
            ...
            i.canCollide(d.collisionFilter, u.collisionFilter) &&
            ((l.midphaseTests += 1), s.overlaps(d.bounds, u.bounds))
          )
            for (var p = d.parts.length > 1 ? 1 : 0; p < d.parts.length; p++)
              for (
                var f = d.parts[p], v = u.parts.length > 1 ? 1 : 0;
                v < u.parts.length;
                v++
              ) {
                var m = u.parts[v];
      ...
      (i.collides = function (e, t, n) {
        ...
        (i._overlapAxes = function (e, t, n) {
          for (
            ...
            o < c.overlap &&
              ((c.overlap = o), (c.axis = s), (c.axisNumber = d));
          }
          return c;
        }),
        ...
        (i._findSupports = function (e, t, n) {
          ...
          return (
            (o = d[s.index - 1 >= 0 ? s.index - 1 : d.length - 1]),
            (c.x = o.x - u.x),
            (c.y = o.y - u.y),
            (l = -r.dot(n, c)),
            (a = o),
        ...
        (i._getRelativeMousePosition = function (e, t, n) {
          var i,
            ...
            s =
              ...
              document.body,
            a =
              void 0 !== window.pageXOffset ? window.pageXOffset : s.scrollLeft,
            l =
              void 0 !== window.pageYOffset ? window.pageYOffset : s.scrollTop,
            c = e.changedTouches;
          return (
            c
              ? ((i = c[0].pageX - r.left - a), (o = c[0].pageY - r.top - l))
              : ((i = e.pageX - r.left - a), (o = e.pageY - r.top - l)),
            {
    ...
    function (e, t, n) {
      ...
      (i.fromVertices = function (e) {
        for (var t = {}, n = 0; n < e.length; n++) {
          var i = (n + 1) % e.length,
            s = o.normalise({ x: e[i].y - e[n].y, y: e[n].x - e[i].x }),
            a = 0 === s.y ? 1 / 0 : s.x / s.y;
    ...
    function (e, t, n) {
      ...
      (i._decompWarned = !1),
        ...
        (i.circle = function (e, t, n, o, s) {
          ...
          return (
            l % 2 == 1 && (l += 1), i.polygon(e, t, l, n, r.extend({}, a, o))
          );
        }),
          ...
          for (
            ...
            if (
              ...
              (b = h ? o.clockwiseSort(b) : o.hull(b)),
                x.push({ position: { x: e, y: t }, vertices: b });
            else {
              ...
              m.makeCCW(M),
                ...
                !1 !== v &&
                  m.removeDuplicatePoints &&
                  m.removeDuplicatePoints(M, v);
              ...
              for (w = 0; w < k.length; w++) {
                ...
                (f > 0 && o.area(B) < f) ||
                  x.push({ position: o.centre(B), vertices: B });
              }
            }
                  ...
                  for (A = 0; A < I.vertices.length; A++)
                    for (C = 0; C < _.vertices.length; C++) {
                      var L = l.magnitudeSquared(
                          l.sub(T[(A + 1) % T.length], R[C])
                        ),
                        O = l.magnitudeSquared(
                          l.sub(T[A], R[(C + 1) % R.length])
                        );
                      L < 5 &&
                        O < 5 &&
                        ((T[A].isInternal = !0), (R[C].isInternal = !0));
                    }
                }
              }
            }
          return x.length > 1
            ? ((g = s.create(r.extend({ parts: x.slice(0) }, d))),
              s.setPosition(g, { x: e, y: t }),
              g)
            : x[0];
        });
    },
                  ...
                  ? i.isUsed(e, l.name) ||
                    ...
                    l.install
                      ...
                      : (o.warn(
                        ...
                        (l._warned = !0)),
                    l._warned
                      ? (s.push("🔶 " + i.toString(l)), delete l._warned)
                      : s.push("✅ " + i.toString(l)),
                    e.used.push(l.name))
                  : s.push("❌ " + r[a]);
              }
            ...
            (e = i.resolve(e) || e),
              (t[r] = o.map(e.uses || [], function (t) {
                ...
                var r = i.dependencyParse(t),
                  s = i.resolve(t);
                return (
                  s && !i.versionSatisfies(s.version, r.range)
                    ? (o.warn(
                        "Plugin.dependencies:",
                        i.toString(s),
                        "does not satisfy",
      ...
      (i._pairMaxIdleLife = 1e3),
        ...
        (i.update = function (e, t, n) {
          var i,
            ...
            p = e.collisionActive;
          for (
            d.length = 0, u.length = 0, p.length = 0, a = 0;
            a < l.length;
            a++
          )
          ...
          for (a = 0; a < t.length; a++)
            (i = t[a]).collided &&
              ((s = c[(r = o.id(i.bodyA, i.bodyB))])
                ? (s.isActive ? p.push(s) : d.push(s),
                  o.update(s, i, n),
                  (s.confirmedActive = !0))
                : ((s = o.create(i, n)), (c[r] = s), d.push(s), l.push(s)));
          for (a = 0; a < l.length; a++)
            (s = l[a]).isActive &&
              !s.confirmedActive &&
              (o.setActive(s, !1, n), u.push(s));
        }),
        (i.removeOld = function (e, t) {
          ...
          for (s = 0; s < a.length; s++)
            (o = (n = a[s]).collision).bodyA.isSleeping || o.bodyB.isSleeping
              ? (n.timeUpdated = t)
              : t - n.timeUpdated > i._pairMaxIdleLife && c.push(s);
          for (s = 0; s < c.length; s++)
            delete l[(n = a[(r = c[s] - s)]).id], a.splice(r, 1);
        }),
        (i.clear = function (e) {
          return (
            (e.table = {}),
        ...
        (i.solvePosition = function (e, t) {
          ...
          for (n = 0; n < e.length; n++)
            (o = e[n]).isActive &&
              ...
              a.isStatic ||
                a.isSleeping ||
                ((u = i._positionDampen / a.totalContacts),
                (a.positionImpulse.x += c.x * p * u),
                (a.positionImpulse.y += c.y * p * u)),
              l.isStatic ||
                l.isSleeping ||
                ((u = i._positionDampen / l.totalContacts),
            ...
            if (f.isActive && !f.isSensor) {
              ...
              for (var w = 0; w < h.length; w++) {
                var S = h[w],
                  ...
                  k = r.add(
                    y.velocity,
                    r.mult(r.perp(C), y.angularVelocity),
                    d
                  ),
                  B = r.sub(M, k, u),
                  I = r.dot(g, B),
                  ...
                  E = _,
                  V = 1 / 0;
                T > f.friction * f.frictionStatic * O * n &&
                  ((V = T), (E = s.clamp(f.friction * R * n, -V, V)));
                var F = r.cross(P, g),
                  W = r.cross(C, g),
                  q =
                    b /
    ...
    function (e, t, n) {
      ...
      (i.create = function (e, t) {
        (t = (t = v.isElement(e) ? t : e) || {}),
          ((e = v.isElement(e) ? e : null) || t.render) &&
        ...
        return (
          ...
          (i.metrics = i.metrics || { extended: !1 }),
        ...
        (i.update = function (e, t, n) {
          ...
          for (
            c.reset(e.metrics),
              ...
              f.preSolveAll(g),
              o = 0;
            o < e.constraintIterations;
            o++
          )
            f.solveAll(x, d.timeScale);
          f.postSolveAll(g),
            v.controller
              ? (a.isModified && v.controller.clear(v),
          ...
          for (
            l.update(b, h, w),
              ...
              b.collisionStart.length > 0 &&
                u.trigger(e, "collisionStart", { pairs: b.collisionStart }),
              s.preSolvePosition(b.list),
              o = 0;
            o < e.positionIterations;
            o++
          )
            s.solvePosition(b.list, d.timeScale);
          for (
            s.postSolvePosition(g), f.preSolveAll(g), o = 0;
            o < e.constraintIterations;
            o++
          )
            f.solveAll(x, d.timeScale);
          for (
            f.postSolveAll(g), s.preSolveVelocity(b.list), o = 0;
            o < e.velocityIterations;
            o++
          )
            s.solveVelocity(b.list, d.timeScale);
          return (
            b.collisionActive.length > 0 &&
              u.trigger(e, "collisionActive", { pairs: b.collisionActive }),
            b.collisionEnd.length > 0 &&
              u.trigger(e, "collisionEnd", { pairs: b.collisionEnd }),
        ...
        (i.update = function (e, t) {
          if (e.extended) {
            ...
            (e.collisions = e.narrowDetections),
              ...
              (e.bodies = i.length),
              (e.midEff = (e.narrowDetections / (e.midphaseTests || 1)).toFixed(
                2
              )),
              (e.narrowEff = (
                e.narrowDetections / (e.narrowphaseTests || 1)
              ).toFixed(2)),
              (e.broadEff = (1 - e.broadphaseTests / (i.length || 1)).toFixed(
                2
              )),
              (e.narrowReuse = (
    ...
    function (e, t, n) {
      ...
      (i.stack = function (e, t, n, i, r, s, l) {
        for (
          var c, d = o.create({ label: "Stack" }), u = e, p = t, f = 0, v = 0;
          v < i;
          v++
        ) {
          ...
          for (var c = e.bodies, d = 1; d < c.length; d++) {
            var u = c[d - 1],
              ...
              y = {
                ...
                pointA: { x: v * t, y: f * n },
                bodyB: p,
                pointB: { x: (p.bounds.max.x - p.bounds.min.x) * i, y: m * a },
              },
              g = s.extend(y, l);
        ...
        (i.pyramid = function (e, t, n, o, r, s, l) {
          return i.stack(e, t, n, o, r, s, function (t, i, s, c, d, u) {
            ...
            if (!(c > p || s < (c = p - c) || s > n - 1 - c))
              return (
                1 === u &&
                  a.translate(d, { x: (s + (n % 2 == 1 ? 1 : -1)) * f, y: 0 }),
        ...
        (i.newtonsCradle = function (e, t, n, i, s) {
          for (
            var a = o.create({ label: "Newtons Cradle" }), c = 0;
            c < n;
            c++
          ) {
    ...
    function (e, t, n) {
      ...
      (i.pathToVertices = function (e, t) {
        ...
        for (
          i._svgPathToAbsolute(e), s = e.getTotalLength(), c = [], n = 0;
          ...
          for (
            ...
            if (/[MLHVCSQTA]/.test(f))
              ...
              switch (
                ...
                case "c":
                  a.replaceItem(
                    e.createSVGPathSegCurvetoCubicAbs(l, c, i, o, r, s),
                    u
                  );
                  break;
                case "s":
      ...
      !(function () {
        ...
        "undefined" != typeof window &&
          ...
          (i.create = function (e) {
            ...
            var t = {
              ...
              n = s.extend(t, e),
              o =
                !n.options.wireframes && "transparent" === n.options.background;
            return (
            ...
            if (c.hasBounds) {
              ...
              for (t = 0; t < u.length; t++) {
                ...
                h && (w = l.add(h.position, x.pointA)),
                  ...
                  w &&
                    S &&
                    (o.contains(e.bounds, w) || o.contains(e.bounds, S)) &&
                    p.push(x);
              }
              a.scale.set(1 / m, 1 / y),
                a.position.set(
            ...
            d || (d = e.primitives[c] = new PIXI.Graphics()),
              l.visible && t.pointA && t.pointB
                ? (-1 === s.indexOf(a.children, d) && a.addChild(d),
                  ...
                  n
                    ? d.moveTo(n.position.x + o.x, n.position.y + o.y)
                    : d.moveTo(o.x, o.y),
                  i
                    ? d.lineTo(i.position.x + r.x, i.position.y + r.y)
                    : d.lineTo(r.x, r.y),
                  d.endFill())
                : d.clear();
          }),
        ...
        var n = function (e, t) {
            var n = t.render.sprite.texture,
              ...
              o = new PIXI.Sprite(i);
            return (
              (o.anchor.x = t.render.sprite.xOffset),
            ...
            for (var p = t.parts.length > 1 ? 1 : 0; p < t.parts.length; p++) {
              (n = t.parts[p]),
                o.wireframes
                  ...
                  : (r.beginFill(a, 1), r.lineStyle(i.lineWidth, l, 1)),
                r.moveTo(
              ...
              r.lineTo(
                ...
                r.endFill(),
                (o.showAngleIndicator || o.showAxes) &&
                  (r.beginFill(0, 0),
                  ...
                  r.lineTo(
                    (n.vertices[0].x + n.vertices[n.vertices.length - 1].x) /
                      2 -
                      t.position.x,
                    (n.vertices[0].y + n.vertices[n.vertices.length - 1].y) /
                      2 -
                      t.position.y
                  ),
                  r.endFill());
